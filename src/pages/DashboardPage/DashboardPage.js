...
export default function DashboardPage() {
  ...
  useEffect(() => {
    app
      .apiClient()
      .getStats((response) => response.content())
      .then((content) => {
        console.log(content);
          ...
          <Grid item xs={12} md={4}>
            <Paper className={equalHeightPaper}>
              <UniqueValueStat
                ...
                value={stats["registered_users_count"]}
              />
            </Paper>
          </Grid>
          <Grid item xs={12} md={4}>
            <Paper className={equalHeightPaper}>
              <UniqueValueStat
                ...
                value={stats["total_count_in_last_30_days"]}
              />
            </Paper>
          </Grid>
          <Grid item xs={12} md={4}>
            <Paper className={equalHeightPaper}>
              <UniqueValueStat
                title={"Average Views"}
                value={stats["average_views"].toFixed(3)}
              />
            </Paper>
          </Grid>
          <Grid item xs={12} md={4}>
            <Paper className={equalHeightPaper}>
              <PrivateVsPublicVideos
                data={stats["private_and_total_vids_count"]}
              />
            </Paper>
          </Grid>
          <Grid item xs={12} md={6}>
            <Paper className={equalHeightPaper}>
              <Top10ErrorsLast30Days
                title="Client errors per path in last 30 days"
                data={stats["cli_errors_per_path_in_last_30_days"]}
              />
            </Paper>
          </Grid>
          <Grid item xs={12} md={6}>
            <Paper className={equalHeightPaper}>
              <Top10ErrorsLast30Days
                title="Server errors per path in last 30 days"
                data={stats["sv_errors_per_path_in_last_30_days"]}
              />
            </Paper>
          </Grid>
          <Grid item xs={12} md={6}>
            <Paper className={equalHeightPaper}>
              <Last30DaysStats
                title="Requests in last 30 days"
                data={stats["requests_in_last_30_days"]}
              />
            </Paper>
          </Grid>
          <Grid item xs={12} md={6}>
            <Paper className={equalHeightPaper}>
              <Last30DaysStats
                title="Server errors in last 30 days"
                data={stats["sv_errors_in_last_30_days"]}
              />
            </Paper>
          </Grid>
          <Grid item xs={12} md={6}>
            <Paper className={equalHeightPaper}>
              <Last30DaysStats
                title="Client errors in last 30 days"
                data={stats["cli_errors_in_last_30_days"]}
              />
            </Paper>
          </Grid>
          <Grid item xs={12} md={6}>
            <Paper className={equalHeightPaper}>
              <Last30DaysStats
                ...
                data={stats["new_users_in_last_30_days"]}
              />
            </Paper>
          </Grid>
          <Grid item xs={12} md={6}>
            <Paper className={equalHeightPaper}>
              <Last30DaysStats
                title="New videos in last 30 days"
                data={stats["new_vids_in_last_30_days"]}
              />
            </Paper>
          </Grid>
          <Grid item xs={12} md={6}>
            <Paper className={equalHeightPaper}>
              <Last30DaysStats
                title="New comments in last 30 days"
                data={stats["new_cmnts_in_last_30_days"]}
              />
            </Paper>
          </Grid>
          <Grid item xs={12} md={6}>
            <Paper className={equalHeightPaper}>
              <Last30DaysStats
                ...
                data={stats["views_in_last_30_days"]}
              />
            </Paper>
          </Grid>
        </Grid>
